...
First just show that you can deploy a new instance of a template from a link in github.

Then go over what is required and what makes that happen:
- Procfile
- requirements.txt
- demo that we can hit it.
...
- Add Flask through package manager
